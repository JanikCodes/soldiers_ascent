...
namespace Crest
{
    ...
    public class LodDataMgrClipSurface : LodDataMgr
    {
        ...
        internal static string MATERIAL_KEYWORD_PROPERTY => RenderPipelineHelper.IsHighDefinition ? "_AlphaClip" : "_ClipSurface";
        internal static string MATERIAL_KEYWORD => RenderPipelineHelper.IsHighDefinition ? "_ALPHATEST_ON" : "_CLIPSURFACE_ON";
