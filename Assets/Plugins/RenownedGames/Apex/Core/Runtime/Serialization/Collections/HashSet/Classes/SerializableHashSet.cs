...
namespace RenownedGames.Apex.Serialization.Collections.Generic
{
    ...
    public abstract class SerializableHashSet<T> : SerializableHashSetBase, ICollection<T>, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>, ISet<T>, IDeserializationCallback, ISerializable
    {
