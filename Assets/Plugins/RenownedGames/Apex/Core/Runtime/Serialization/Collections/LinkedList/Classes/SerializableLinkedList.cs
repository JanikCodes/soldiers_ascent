...
namespace RenownedGames.Apex.Serialization.Collections.Generic
{
    ...
    public abstract class SerializableLinkedList<T> : SerializableLinkedListBase, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>, ICollection, IDeserializationCallback, ISerializable
    {
        ...
        {
            SetValues(new List<T>(linkedList));
        }
        #endregion
