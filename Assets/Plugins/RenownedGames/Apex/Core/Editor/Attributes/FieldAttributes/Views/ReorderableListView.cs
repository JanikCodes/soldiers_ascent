...
namespace RenownedGames.ApexEditor
{
    ...
    public sealed class ReorderableListView : FieldView, ITypeValidationCallback
    {
        ...
        {
            reorderableList = new ReorderableList(serializedField.GetSerializedObject(), serializedField.GetSerializedProperty(), true, true, true, true)
            {
            ...
            if (onAddDropdownElement != null)
            {
                ...
                {
                    onAddDropdownElement.Invoke(target, new object[2] { rect, list.serializedProperty });
                };
            }
        }
        ...
        private void FindCallbacks(object target, ReorderableListAttribute attribute)
        {
            ...
            foreach (MethodInfo methodInfo in type.AllMethods(limitDescendant))
            {
                if (onHeaderGUI != null
                    && onElementGUI != null
                    && onNoneElementGUI != null
                    && getElementHeight != null
                    && onAddElement != null
                    && onAddDropdownElement != null
                ...
                if (onElementGUI == null && methodInfo.IsValidCallback(attribute.OnElementGUI, typeof(void), typeof(Rect), typeof(SerializedProperty), typeof(GUIContent)))
                {
