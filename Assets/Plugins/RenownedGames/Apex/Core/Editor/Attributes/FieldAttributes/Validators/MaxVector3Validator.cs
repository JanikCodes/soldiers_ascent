...
{
    [ValidatorTarget(typeof(MaxVector3Attribute))]
    public sealed class MaxVector3Validator : FieldValidator, ITypeValidationCallback
    {
        private SerializedProperty property;
        private MaxVector3Attribute attribute;
        ...
        {
            attribute = validatorAttribute as MaxVector3Attribute;
                ...
                case SerializedPropertyType.Vector3Int:
                    {
                        ...
                        {
                            x = Mathf.Min(x, System.Convert.ToInt32(attribute));
                        }
                        ...
                        {
                            y = Mathf.Min(y, System.Convert.ToInt32(attribute));
                        }

                        int z = property.vector3IntValue.z;
                        if (zProperty != null)
                        {
                            z = Mathf.Min(z, zProperty.intValue);
                        }
                        else if (attribute.zProperty != null)
                        {
                            z = Mathf.Min(z, System.Convert.ToInt32(attribute.z));
                        }
                ...
                case SerializedPropertyType.Vector3:
                    {
                        ...
                        if (zProperty != null)
                        {
                            z = Mathf.Min(z, zProperty.floatValue);
                        }
                        else if (attribute.zProperty != null)
                        {
                            z = Mathf.Min(z, attribute.z);
                        }
