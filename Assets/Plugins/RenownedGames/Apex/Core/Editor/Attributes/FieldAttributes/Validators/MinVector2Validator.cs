...
{
    [ValidatorTarget(typeof(MinVector2Attribute))]
    public sealed class MinVector2Validator : FieldValidator, ITypeValidationCallback
    {
        private MinVector2Attribute attribute;
        ...
        {
            attribute = validatorAttribute as MinVector2Attribute;
                ...
                case SerializedPropertyType.Vector2Int:
                    {
                        ...
                        {
                            x = Mathf.Max(x, System.Convert.ToInt32(attribute.x));
                        }
                        ...
                        {
                            y = Mathf.Max(y, System.Convert.ToInt32(attribute.y));
                        }
