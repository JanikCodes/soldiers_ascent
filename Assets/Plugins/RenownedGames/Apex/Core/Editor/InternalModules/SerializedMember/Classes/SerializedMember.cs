...
namespace RenownedGames.ApexEditor
{
    public abstract class SerializedMember : VisualEntity, ISerializedMember, IMemberInfo, IMemberDeclaringObject, IMemberType, IMemberLabel, IGUIChangedCallback
    {
        ...
        /// </summary>
        static SerializedMember()
        {
            ManipulatorsNone = new List<MemberManipulator>();
        }
        ...
        public SerializedMember(SerializedObject serializedObject, string memberPath) : base(memberPath)
        {
