...
namespace RenownedGames.ApexEditor
{
    public class GroupContainer : ListContainer
    {
        ...
        public GroupContainer(string name, List<VisualEntity> entities) : base(name, entities) 
        {
            headerHeight = 22;
        }
        ...
        /// </summary>
        /// <param name="position">Rectangle position.</param>
        protected virtual void OnContentGUI(Rect position)
        {
            base.OnGUI(position);
        }
