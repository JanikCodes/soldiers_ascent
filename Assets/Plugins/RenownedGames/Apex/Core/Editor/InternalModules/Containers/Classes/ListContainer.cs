...
namespace RenownedGames.ApexEditor
{
    public abstract class ListContainer : Container, IListContainer
    {
        ...
        protected ListContainer(string name) : base(name)
        {
            this.entities = new List<VisualEntity>();
        }

        protected ListContainer(string name, List<VisualEntity> entities) : base(name)
        {
        ...
        public VisualEntity GetEntity(int index)
        {
            return entities[index];
        }

        public void SetEntity(int index, VisualEntity entity)
        {
