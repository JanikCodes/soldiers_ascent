...
namespace RenownedGames.ApexEditor
{
    public sealed class TabContainer : Container, ITabContainer, IGUIChangedCallback
    {
        ...
        public TabContainer(string name, List<Tab> tabs) : base(name)
        {
            this.tabs = tabs;
            headerHeight = 22;
        }
        ...
        public override float GetHeight()
        {
            ...
            return headerHeight
                + (EditorGUIUtility.standardVerticalSpacing * 2) * ApexGUIUtility.BoxBounds
                + GetEntitiesHeight(in tab.entities);
        }
        #endregion
        ...
        public void SetTabs(List<Tab> value)
        {
            tabs = value;
        }
        #endregion
