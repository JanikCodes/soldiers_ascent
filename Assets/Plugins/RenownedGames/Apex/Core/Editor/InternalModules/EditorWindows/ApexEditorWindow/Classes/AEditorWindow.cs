...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        INTERATION_1:
            for (int i = 0; i < visualElements.Count; i++)
            {
                ...
                if (visualElement is SerializedMember serializedMember)
                {
                    ...
                    if (attribute != null)
                    {
                        FoldoutContainer foldout = visualElements.Where(e => e is FoldoutContainer f && f.GetName() == attribute.Name).FirstOrDefault() as FoldoutContainer;
                        if (foldout != null)
                        {
        ...
        INTERATION_1:
            for (int i = 0; i < visualElements.Count; i++)
            {
                ...
                if (visualElement is SerializedMember serializedMember)
                {
                    ...
                    if (attribute != null)
                    {
                        HorizontalContainer horizontalGroup = visualElements.Where(e => e is HorizontalContainer h && h.GetName() == attribute.Name).FirstOrDefault() as HorizontalContainer;
        ...
        public void CopyVisualElementsTo(ref List<VisualEntity> list)
        {
            list = new List<VisualEntity>(visualElements);
        }
