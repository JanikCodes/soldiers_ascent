...
namespace RenownedGames.ApexEditor
{
    ...
    public class SerializedMethod : SerializedMember
    {
        ...
        public SerializedMethod(SerializedObject serializedObject, string memberName) : base(serializedObject, memberName) 
        {
        ...
        protected override void OnMemberGUI(Rect position)
        {
            ...
            if (argCount == 0)
            {
                ...
                else
                {
                    ...
                    {
                        IconButtonStyle.Draw(position, keepCall ? PauseButtonTexture : PlayButtonTexture, hover && !isPressed, true, false, false);
                    }
                }
            }
            else
        ...
        {
            return onClick.Invoke(GetDeclaringObject(), null);
        }
        ...
        public void SetStyle(GUIStyle value)
        {
            style = value;
        }
        #endregion
