...
namespace RenownedGames.ApexEditor
{
    public sealed class HandlesSpace : VisualEntity
    {
        ...
        public HandlesSpace(string name, Action<Vector2> onGUI, Func<float> getHeight, bool showTitle = false, bool showBackground = false) : base(name)
        {
            this.onGUI = onGUI;
        ...
        public void SetShowTitle(bool value)
        {
            showTitle = value;
        }
        ...
        public void SetShowBackground(bool value)
        {
        ...
        public void SetTitleStyle(GUIStyle value)
        {
            titleStyle = value;
        }
        #endregion
