...
namespace RenownedGames.ApexEditor
{
    public class SerializedCsProperty : SerializedMember
    {
        ...
        public SerializedCsProperty(SerializedObject serializedObject, string memberName) : base(serializedObject, memberName) { }
        ...
        {
            if (GetMemberInfo() is PropertyInfo propertyInfo
                && propertyInfo != null
