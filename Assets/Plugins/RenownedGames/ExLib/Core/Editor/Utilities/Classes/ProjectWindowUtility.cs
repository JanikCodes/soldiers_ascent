...
namespace RenownedGames.ExLibEditor
{
    public static class ProjectWindowUtility
    {
        private class DoCreateScriptAsset : EndNameEditAction
        {
            public override void Action(int instanceId, string pathName, string resourceFile)
            {
                UnityEngine.Object o =
                    ...
                    .GetMethod("CreateScriptAssetFromTemplate", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic)
        ...
        public static void CreateScriptAssetFromTemplateFile(string templatePath, string defaultNewFileName, Texture2D icon)
        {
            ...
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, ScriptableObject.CreateInstance<DoCreateScriptAsset>(), $"{defaultNewFileName}.cs", icon, templatePath);
        ...
        public static void CreateScriptableObject<T>(string defaultNewFileName, Texture2D icon) where T : ScriptableObject
        {
            ...
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, createScriptableObject, $"{defaultNewFileName}.asset", icon, null);
        }
    }
}