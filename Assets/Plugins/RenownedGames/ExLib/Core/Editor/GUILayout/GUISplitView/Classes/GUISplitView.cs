...
namespace RenownedGames.ExLibEditor
{
    public sealed class GUISplitView : ISplitView
    {
        ...
        public GUISplitView(Direction splitDirection, float minPosition, float maxPosition) : this(splitDirection)
        {
        ...
        /// <param name="minPosition">Min possible split view position, ranged: [0...1].</param>
        /// <param name="maxPosition">Max possible split view position, ranged: [0...1].</param>
        public GUISplitView(Direction splitDirection, float splitPosition, float minPosition, float maxPosition) : this(splitDirection, minPosition, maxPosition)
        {
        ...
        public void SetSplitDirection(Direction value)
        {
