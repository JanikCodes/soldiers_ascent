...
namespace RenownedGames.ExLib.Maths
{
    public class CompositeShapeData
    {
        ...
        public bool IsParentOf(CompositeShapeData otherShape)
        {
            ...
            {
                if (Math2D.PointInTriangle(polygon.GetPoints()[triangles[i]], polygon.GetPoints()[triangles[i + 1]], polygon.GetPoints()[triangles[i + 2]], otherShape.points[0]))
                {
        ...
        public List<CompositeShapeData> GetParents()
        {
            return parents;
        }

        public List<CompositeShapeData> GetHoles()
        {
            return holes;
        }
        #endregion
