...
{
    [NodeContent("Select Random Vector3", "Tasks/Vector 3/Select Random Vector3", IconPath = "Images/Icons/Node/Vector3Icon.png")]
    public class V3SelectRandomTask : TaskNode
    {
        [System.Serializable]
        private struct VectorElement
        {
            public Vector3Key vector;
        ...
        protected override State OnUpdate()
        {
            ...
            Vector3 vector = GetVectorRandomly();
            storeResult.SetValue(vector);

            return State.Success;
        }

        private Vector3 GetVectorRandomly()
        {
            float totalWeight = 0;
