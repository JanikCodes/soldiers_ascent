...
{
    [NodeContent("Sphere Cast", "Tasks/Physics/Sphere Cast", IconPath = "Images/Icons/Node/RayIcon.png")]
    public class SphereCastTask : TaskNode
    {
        [Title("Node")]
        [SerializeField]
        ...
        protected override State OnUpdate()
        {
            ...
            if (Physics.SphereCast(ray, radius, out RaycastHit hitInfo, maxDistance, cullingLayer, queryTriggerInteraction))
            {
