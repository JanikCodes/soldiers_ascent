...
{
    [NodeContent("Ray Cast 2D", "Tasks/Physics 2D/Ray Cast 2D", IconPath = "Images/Icons/Node/RayIcon.png")]
    public class RayCast2DTask : TaskNode
    {
        [Title("Node")]
        [SerializeField]
        ...
        protected override State OnUpdate()
        {
            ...
            RaycastHit2D hitInfo = Physics2D.Raycast(ray.origin, ray.direction, maxDistance, cullingLayer);
